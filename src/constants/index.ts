...
export const ESTADO_SANITARIO_BADGE_CLASSES: Record<string, string> = {
  sin_verificar: 'bg-slate-100 text-slate-700',
...
export const PUESTO_PUBLICO_ERRORS = {
  notAvailable: 'Este puesto no está disponible',
} as const;

export function formatFechaActualizacion(isoDate: string): string {
