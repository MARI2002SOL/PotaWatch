...
import { BuscarPuestosPage } from '../pages/BuscarPuestosPage';
import { PuestoPublicoPage } from '../pages/PuestoPublicoPage';
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<AppLayout />}>
          ...
          <Route path="puesto/:id" element={<PuestoPublicoPage />} />
